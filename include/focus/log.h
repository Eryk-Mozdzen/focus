...
#define FOCUS_LOG_DBG(...)                                                                         \
    FOCUS_LOG(FOCUS_LOG_LEVEL_DEBUG, FOCUS_LOG_MODULE, __FILE__, __LINE__, __VA_ARGS__)
#define FOCUS_LOG_INFO(...)                                                                        \
    FOCUS_LOG(FOCUS_LOG_LEVEL_INFO, FOCUS_LOG_MODULE, __FILE__, __LINE__, __VA_ARGS__)
#define FOCUS_LOG_WARN(...)                                                                        \
    FOCUS_LOG(FOCUS_LOG_LEVEL_WARNING, FOCUS_LOG_MODULE, __FILE__, __LINE__, __VA_ARGS__)
#define FOCUS_LOG_ERR(...)                                                                         \
    FOCUS_LOG(FOCUS_LOG_LEVEL_ERROR, FOCUS_LOG_MODULE, __FILE__, __LINE__, __VA_ARGS__)
